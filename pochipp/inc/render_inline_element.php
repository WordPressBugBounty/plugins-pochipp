...
function render_pochipp_element( $btn_data = [] ) {
	...
	if ( 'button' === $type ) {
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Fragments are fixed markup or escaped above.
		echo "
	...
	if ( 'img' === $type ) {
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Image markup is generated by the plugin helper.
